    ...
    return(
        <div className="app">
            ...
            <div className="collection">
                ...
                <button
                onClick={()=>{const newId=Math.max(...tasks.map((name)=>name.id));
            ...
            <ul>
                {tasks.map((curTask)=>(<li key={curTask.id}>
                    <input type="text" value={curTask.name} onChange={(e)=>{
                        dispatch(setUpdatedTask({id: curTask.id,name:e.target.value}));
                        }}></input>
                        <button 
                        onClick={()=>{
                            dispatch({
