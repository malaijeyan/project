...
const ProductSlice = createSlice({
    ...
    reducers:{
        ...
        setUpdatedTask:(state,action)=>{
            state.tasks=state.tasks.map((productname)=>{
                if(productname.id===action.payload.id){
                    productname.productname=action.payload.productname;
                }
            });
        },
        ...
        deleteTask(state,action){
            state.tasks=state.tasks.filter((productname)=>(productname.id!==state.delId));
            state.errorMessage="";
        },
